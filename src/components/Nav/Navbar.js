            ...
            <ul className="nav-menu" style={this.state.navClose}>
              ...
              <li>
                ...
                <ul className="nav-submenu">
                  ...
                  <li>
                    <Link to={`${process.env.PUBLIC_URL}/kids`}>{"kids"}</Link>
                  </li>
                  <li>
                    <Link to={`${process.env.PUBLIC_URL}/pets`}>{"pets"}</Link>
                  </li>
                  <li>
