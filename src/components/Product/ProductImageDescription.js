...
const ProductImageDescription = ({
  ...
  const discountedPrice = 1; /*getDiscountPrice(product.price, product.discount);*/
  const finalProductPrice = 1; /*+(product.price * currency.currencyRate).toFixed(2);*/
